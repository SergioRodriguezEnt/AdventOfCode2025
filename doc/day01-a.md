...
The DialState class (inner class of Day01ARunner) is there to keep count of the number of zeros that have appeared.<br>
Finally, the Day01ARunner class acts as the controller for the program, parsing the inputs and obtaining the results.<br>
<br>
